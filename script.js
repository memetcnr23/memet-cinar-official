...
// .env içinde OPENAI_API_KEY değişkeni olmalı
// Örn: OPENAI_API_KEY=sk-..... (dosyayı asla public repo'ya atma)
...
app.post("/lonca-ai", async (req, res) => {
  ...
  try {
    const completion = await client.chat.completions.create({
      model: "gpt-4o", // veya gpt-4o-mini, gpt-4.1 vs. hesabına göre
      messages: [
        {
          role: "system",
          content:
